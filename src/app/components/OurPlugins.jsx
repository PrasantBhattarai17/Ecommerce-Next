        ...
        <>
            <div className='flex flex-col gap-14 lg:px-40 md:px-20 px-7 py-40 bg-slate-100'>
                <div className='flex justify-between gap-4 flex-wrap'>
                    ...
                    <Link href='/plugins' className='font-semibold py-3 px-6 bg-white border border-indigo-500 hover:bg-indigo-500 transition duration-300 hover:text-white rounded-md'>
                        View all plugins
                    </Link>
                </div>
                            ...
                            return (
                                <div key={e.id} className='flex flex-wrap flex-col justify-center text-center w-96 px-2 group'>
                                        ...
                                        <div className='absolute top-4 right-4'>
                                            <button
                                                onClick={(event) => {
                                                    ...
                                                    if (inWishlist) {
                                                        removeFromWishlist(e.id, 'plugins')
                                                    } else {
                                                        addToWishlist({ ...e, type: 'plugins' })
                                                    }
                                                }}
                                    ...
                                    <button
                                        ...
                                        onClick={() => addToCart({ ...e, type: 'plugins' })}
                                    >
                                        <FaShoppingCart />
                                        Add to Cart
                                    </button>
